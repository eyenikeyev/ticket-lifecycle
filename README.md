...
<p>
Note: Priorities have not been set for other incoming tickets such as ticket #951432 where end user Ken is requesting an upgrade to Adobe Reader. SLA plans need to be set for these tickets hence why they are all under the priority state of "Normal"
</p>
